...
class PlayerState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mover.proto.PlayerState) */ {
 public:
  PlayerState();
  virtual ~PlayerState();
  ...
  // optional .mover.proto.Direction dir = 3;
  bool has_dir() const;
  void clear_dir();
  static const int kDirFieldNumber = 3;
  ::mover::proto::Direction dir() const;
  void set_dir(::mover::proto::Direction value);
  ...
  // @@protoc_insertion_point(class_scope:mover.proto.PlayerState)
 private:
...
class GameState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mover.proto.GameState) */ {
 public:
  GameState();
  virtual ~GameState();
  ...
  // map<string, .mover.proto.PlayerState> players = 1;
  int players_size() const;
  void clear_players();
  static const int kPlayersFieldNumber = 1;
  const ::google::protobuf::Map< ::std::string, ::mover::proto::PlayerState >&
      players() const;
  ::google::protobuf::Map< ::std::string, ::mover::proto::PlayerState >*
      mutable_players();

  // @@protoc_insertion_point(class_scope:mover.proto.GameState)
 private:
  ...
  typedef ::google::protobuf::internal::MapEntryLite<
      ::std::string, ::mover::proto::PlayerState,
...
class PlayerUndo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mover.proto.PlayerUndo) */ {
 public:
  PlayerUndo();
  virtual ~PlayerUndo();
  ...
  // optional .mover.proto.Direction previous_dir = 2;
  bool has_previous_dir() const;
  void clear_previous_dir();
  static const int kPreviousDirFieldNumber = 2;
  ::mover::proto::Direction previous_dir() const;
  void set_previous_dir(::mover::proto::Direction value);
  ...
  // optional .mover.proto.Direction finished_dir = 4;
  bool has_finished_dir() const;
  void clear_finished_dir();
  static const int kFinishedDirFieldNumber = 4;
  ::mover::proto::Direction finished_dir() const;
  void set_finished_dir(::mover::proto::Direction value);

  // @@protoc_insertion_point(class_scope:mover.proto.PlayerUndo)
 private:
...
class UndoData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mover.proto.UndoData) */ {
 public:
  UndoData();
  virtual ~UndoData();
  ...
  // map<string, .mover.proto.PlayerUndo> players = 1;
  int players_size() const;
  void clear_players();
  static const int kPlayersFieldNumber = 1;
  const ::google::protobuf::Map< ::std::string, ::mover::proto::PlayerUndo >&
      players() const;
  ::google::protobuf::Map< ::std::string, ::mover::proto::PlayerUndo >*
      mutable_players();

  // @@protoc_insertion_point(class_scope:mover.proto.UndoData)
 private:
  ...
  mutable int _cached_size_;
  typedef ::google::protobuf::internal::MapEntryLite<
      ::std::string, ::mover::proto::PlayerUndo,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 >
...
inline ::google::protobuf::int32 PlayerState::x() const {
  // @@protoc_insertion_point(field_get:mover.proto.PlayerState.x)
  return x_;
}
inline void PlayerState::set_x(::google::protobuf::int32 value) {
  set_has_x();
  x_ = value;
  // @@protoc_insertion_point(field_set:mover.proto.PlayerState.x)
}
...
inline ::google::protobuf::int32 PlayerState::y() const {
  // @@protoc_insertion_point(field_get:mover.proto.PlayerState.y)
  return y_;
}
inline void PlayerState::set_y(::google::protobuf::int32 value) {
  set_has_y();
  y_ = value;
  // @@protoc_insertion_point(field_set:mover.proto.PlayerState.y)
}
...
inline ::mover::proto::Direction PlayerState::dir() const {
  // @@protoc_insertion_point(field_get:mover.proto.PlayerState.dir)
  return static_cast< ::mover::proto::Direction >(dir_);
}
inline void PlayerState::set_dir(::mover::proto::Direction value) {
  assert(::mover::proto::Direction_IsValid(value));
  set_has_dir();
  dir_ = value;
  // @@protoc_insertion_point(field_set:mover.proto.PlayerState.dir)
}
...
inline ::google::protobuf::uint32 PlayerState::steps_left() const {
  // @@protoc_insertion_point(field_get:mover.proto.PlayerState.steps_left)
  return steps_left_;
}
inline void PlayerState::set_steps_left(::google::protobuf::uint32 value) {
  set_has_steps_left();
  steps_left_ = value;
  // @@protoc_insertion_point(field_set:mover.proto.PlayerState.steps_left)
}
...
inline const ::google::protobuf::Map< ::std::string, ::mover::proto::PlayerState >&
GameState::players() const {
  // @@protoc_insertion_point(field_map:mover.proto.GameState.players)
  return players_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::mover::proto::PlayerState >*
GameState::mutable_players() {
  // @@protoc_insertion_point(field_mutable_map:mover.proto.GameState.players)
...
inline bool PlayerUndo::is_new() const {
  // @@protoc_insertion_point(field_get:mover.proto.PlayerUndo.is_new)
  return is_new_;
}
inline void PlayerUndo::set_is_new(bool value) {
  set_has_is_new();
  is_new_ = value;
  // @@protoc_insertion_point(field_set:mover.proto.PlayerUndo.is_new)
}
...
inline ::mover::proto::Direction PlayerUndo::previous_dir() const {
  // @@protoc_insertion_point(field_get:mover.proto.PlayerUndo.previous_dir)
  return static_cast< ::mover::proto::Direction >(previous_dir_);
}
inline void PlayerUndo::set_previous_dir(::mover::proto::Direction value) {
  assert(::mover::proto::Direction_IsValid(value));
  set_has_previous_dir();
  previous_dir_ = value;
  // @@protoc_insertion_point(field_set:mover.proto.PlayerUndo.previous_dir)
}
...
inline ::google::protobuf::uint32 PlayerUndo::previous_steps_left() const {
  // @@protoc_insertion_point(field_get:mover.proto.PlayerUndo.previous_steps_left)
...
inline void PlayerUndo::set_previous_steps_left(::google::protobuf::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:mover.proto.PlayerUndo.previous_steps_left)
}
...
inline ::mover::proto::Direction PlayerUndo::finished_dir() const {
  // @@protoc_insertion_point(field_get:mover.proto.PlayerUndo.finished_dir)
  return static_cast< ::mover::proto::Direction >(finished_dir_);
}
inline void PlayerUndo::set_finished_dir(::mover::proto::Direction value) {
  assert(::mover::proto::Direction_IsValid(value));
  set_has_finished_dir();
  finished_dir_ = value;
  // @@protoc_insertion_point(field_set:mover.proto.PlayerUndo.finished_dir)
}
...
inline const ::google::protobuf::Map< ::std::string, ::mover::proto::PlayerUndo >&
UndoData::players() const {
  // @@protoc_insertion_point(field_map:mover.proto.UndoData.players)
  return players_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::mover::proto::PlayerUndo >*
UndoData::mutable_players() {
  // @@protoc_insertion_point(field_mutable_map:mover.proto.UndoData.players)
  return players_.MutableMap();
}
...
template <> struct is_proto_enum< ::mover::proto::Direction> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mover::proto::Direction>() {
  return ::mover::proto::Direction_descriptor();
}
